...
| M03 | 3D orbit, worker-termination cancel, spatial oracle, CopyBay (M03-A), separate model/analysis Workers (M03-B) | Physical/analytical hierarchy UI, 5,000-node multibay generator, full 30,000-DOF capacity/performance |
