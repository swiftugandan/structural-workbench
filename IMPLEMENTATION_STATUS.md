...
| M03 | 3D orbit, worker termination cancellation, spatial oracle, CopyBay portal→bays→roof ties→My/Mz/T journey (M03-A) | Separate model/analysis Workers, physical/analytical hierarchy UI, 5,000-node multibay generator, full 30,000-DOF capacity/performance |
