...
| M03 | 3D orbit, cancel, spatial oracle, CopyBay, dual Workers, OpenSees pack, 5k-node capacity, unit-action/roll, section-axis edit, hierarchy UI — **parent accepted** (`evidence/M03/full`) | — |
