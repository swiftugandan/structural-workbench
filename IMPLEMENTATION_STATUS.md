...
| M03 | 3D orbit, cancel, spatial oracle, CopyBay (M03-A), dual Workers (M03-B), OpenSees pack (M03-C), 5k-node multibay solve + memory guard (M03-D), all-axis unit-action + localY roll/section-axis edit (M03-E), physical/analytical hierarchy UI (M03-F) | Parent M03 verifier packaging |
